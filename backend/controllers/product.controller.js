...
async function updateFeaturedProductsCache(){
    try {
        ...
        // This can improve performance when you don't need the full Mongoose document functionality.
        const feauturedProducts = await Product.find({ isFeatured: true }).lean();
